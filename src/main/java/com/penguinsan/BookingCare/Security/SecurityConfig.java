    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .requestMatchers("/user/doctor/add/image").hasAnyAuthority("ADMIN")
                        .requestMatchers("/user/doctor/add").hasAnyAuthority("ADMIN")
                        .requestMatchers("/user/doctor/update/{doctorId}").permitAll()
                        .requestMatchers("/user/doctorAll").permitAll()
                        .requestMatchers("/user/doctor/experience").permitAll()
